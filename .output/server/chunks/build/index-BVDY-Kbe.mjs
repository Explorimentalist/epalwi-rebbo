    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(indexedDBResult)) {
        ...
        if (unref(indexedDBResult).cacheValid !== void 0) {
          _push(`<p data-v-6cfbe2b1> Cache Valid: <span class="${ssrRenderClass(unref(indexedDBResult).cacheValid ? "text-green-600" : "text-orange-600")}" data-v-6cfbe2b1>${ssrInterpolate(unref(indexedDBResult).cacheValid ? "\u2705 Yes" : "\u{1F504} No (needs refresh)")}</span></p>`);
        } else {
          _push(`<!---->`);
        }
      ...
      _push(`</div></section><section class="mb-8 p-4 border rounded-lg" data-v-6cfbe2b1><h2 class="text-xl font-semibold mb-4" data-v-6cfbe2b1>\u{1F50D} Search Service Test</h2><div class="space-y-4" data-v-6cfbe2b1><div class="flex gap-2" data-v-6cfbe2b1><input${ssrRenderAttr("value", unref(searchQuery))} placeholder="Enter search term (e.g., casa, hola)" class="flex-1 px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500" data-v-6cfbe2b1><select class="px-3 py-2 border rounded" data-v-6cfbe2b1><option value="spanish" data-v-6cfbe2b1${ssrIncludeBooleanAttr(Array.isArray(unref(searchLanguage)) ? ssrLooseContain(unref(searchLanguage), "spanish") : ssrLooseEqual(unref(searchLanguage), "spanish")) ? " selected" : ""}>Espa\xF1ol</option><option value="ndowe" data-v-6cfbe2b1${ssrIncludeBooleanAttr(Array.isArray(unref(searchLanguage)) ? ssrLooseContain(unref(searchLanguage), "ndowe") : ssrLooseEqual(unref(searchLanguage), "ndowe")) ? " selected" : ""}>Ndowe</option></select><button${ssrIncludeBooleanAttr(unref(searchLoading) || !unref(searchQuery)) ? " disabled" : ""} class="px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600 disabled:opacity-50" data-v-6cfbe2b1>${ssrInterpolate(unref(searchLoading) ? "Searching..." : "Search")}</button></div>`);
...
//# sourceMappingURL=index-BVDY-Kbe.mjs.map
